...
- **R23 — the league read path is the product's cost.** A review on 2026-08-31
  ...
  *wrong data*: the two unbounded duel reads, the Node aggregation (now **migration 130**), and the
  second scoring engine in the browser. ⚠ **130 is unexecuted and must be applied before the deploy.**
...
⚠ **130 has not been executed anywhere and must be applied BEFORE the code deploys.** Both risks
...
| ~~2~~ | ✅ **DONE** `6aa2831` — migration **130**, returns one row whatever the pool size, breakdown included. ⚠ **unexecuted, and must be applied BEFORE the deploy** | — | The rule, applied where we broke it |
...
✅ **Items 1–3 landed 2026-09-02** (`6aa2831`), which is the whole *“before Premier League carries load”* block. ⚠ Migration **130 is unexecuted and must be applied before the deploy** — the code names the function from here on. **Items 4–7 are open**, and 4–5 are the
