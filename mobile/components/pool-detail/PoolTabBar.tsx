...
// Re-exported so every existing consumer keeps importing tabs from the tab
// bar: `lib/poolTabs.ts` owns the rule, this file owns the rendering.
export { getVisiblePoolTabs, type PoolTabKey };
