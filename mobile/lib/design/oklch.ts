...
// =============================================================
// ⚠ MIRRORED FROM lib/design/oklch.ts AT THE REPO ROOT. Byte-for-byte below
// this banner. The web file's own header anticipated this: "lib/design is
// mirrored into the React Native app where a transitive dependency costs more
// than the maths does." Mobile is a separate npm project with its own lockfile,
// so it cannot import the original — see drafts/2026-09-02_rn_league_modes_and_
// cards_plan.md, gate R1, which exists to end copies like this one.
//
// If you change the maths, change BOTH. A stripe that differs between the two
// surfaces is the same class of drift that once had them disagreeing about a
// member's level.
// =============================================================
