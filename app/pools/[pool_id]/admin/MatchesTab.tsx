...
export function MatchesTab({
  ...
  return (
    <div>
      ...
      {/* Info banner */}
      <div className="flex items-start gap-3 bg-primary-50 border border-primary-200 rounded-xl px-4 py-3 mb-6 dark:bg-primary-900/20 dark:border-primary-800">
        <svg className="w-5 h-5 text-primary-700 dark:text-primary-600 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
        </svg>
        <p className="text-sm text-primary-700 dark:text-primary-600 leading-5">
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50">
          <div className="bg-surface rounded-t-2xl sm:rounded-2xl shadow-xl sm:max-w-lg w-full sm:mx-4 p-4 sm:p-6 max-h-[85vh] overflow-y-auto dark:shadow-none dark:border dark:border-border-default">
            ...
            {modal.match.is_completed && (
              <div className="flex items-start gap-3 bg-primary-50 border border-primary-200 rounded-xl px-4 py-2 mb-4 dark:bg-primary-900/20 dark:border-primary-800">
                <svg className="w-5 h-5 text-primary-700 dark:text-primary-600 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                </svg>
                <p className="text-sm font-medium text-primary-700 dark:text-primary-600 leading-5">
