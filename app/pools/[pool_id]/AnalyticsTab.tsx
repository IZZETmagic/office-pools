...
export function AnalyticsTab({
  ...
  if (completedMatches.length === 0) {
    return (
      <div className="bg-surface rounded-control shadow dark:shadow-none dark:border dark:border-border-default p-8 text-center">
      ...
      {showEntrySelector && (
        <div className="flex items-center justify-end gap-2">
          ...
          <select
            ...
            className="text-sm bg-surface border border-neutral-300 dark:border-neutral-600 rounded-chip px-3 py-1.5 text-neutral-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
          >
