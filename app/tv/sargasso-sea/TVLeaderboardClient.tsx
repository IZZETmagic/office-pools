...
import type { LeaderboardPlayer } from '@/app/play/sargasso-sea/getLeaderboard'
...
export function TVLeaderboardClient({
  ...
  useEffect(() => {
    ;(async () => {
      ...
      const url = await QRCode.toDataURL(`${window.location.origin}/play/sargasso-sea`, {
        width: 80,
        margin: 1,
          ...
          <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/[0.06]">
            ...
            <div className="flex items-center gap-3 px-4 py-2 rounded-xl border border-white/[0.08]" style={{ backgroundColor: 'rgba(255,255,255,0.04)' }}>
              ...
              <div>
                ...
                <p className="text-[11px] text-white/25">sportpool.io/play/sargasso-sea</p>
              </div>
            </div>
          </div>
        </div>
