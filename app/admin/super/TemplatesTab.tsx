...
const TEMPLATES: TemplateDef[] = [
  ...
  },
  {
    key: 'support_reply',
    label: 'Support Reply',
    description: 'Reply to a user\'s support request with SportPool branding. Uses a neutral support design — not a marketing email.',
    category: 'support',
        ...
        <>
          ...
          {selectedTemplate === 'support_reply' && (
            <>
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 sp-radius-sm p-4">
                <p className="text-sm text-blue-800 dark:text-blue-300">
                  Reply to a user's support request with SportPool branding. Uses a neutral support design with a help-desk tone instead of the marketing template.
                </p>
              </div>
